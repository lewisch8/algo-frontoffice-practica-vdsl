...
BOOST_AUTO_TEST_CASE(test_cashflow_amounts) {
    ...
    BOOST_TEST_MESSAGE("Número de flujos generados: " << flujos.size());
    ...
    // Verificar el primer flujo
    double expected = nominal * tipo_fijo * flujos[0].year_fraction;
    
    BOOST_TEST_MESSAGE("VERIFICACIÓN DEL PRIMER FLUJO:");
    BOOST_TEST_MESSAGE("  - Cálculo esperado: nominal * tipo_fijo * fracción");
    BOOST_TEST_MESSAGE("    = " << expected << " EUR");
